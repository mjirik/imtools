...
MOCK_MODULES = [
    ...
    'larcc.MAP', 'PyQt5', 'PyQt5.QtCore', 'PyQt5.QtGui', 'web', 'lar2psm',
    ...
    'gzip', 'cPickle',
    'lbpLibrary', 'skimage.exposure', 'PyQt5.QVTKRenderWindowInteractor',
    'matplotlib.backends', 'matplotlib.backends.backend_qt5agg', 'numpy.linalg',
    'PyQt5.Qt', 'matplotlib.figure', 'skimage.morphology', 'gtk',
    'pysegbase.seed_editor_qt', 'vtk.qt5', 'vtk.qt5.QVTKRenderWindowInteractor',
